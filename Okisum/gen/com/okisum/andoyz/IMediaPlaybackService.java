 ...
 * Original file: C:\\Development\\Okisum\\src\\com\\okisum\\andoyz\\IMediaPlaybackService.aidl
 */
package com.okisum.andoyz;
public interface IMediaPlaybackService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.okisum.andoyz.IMediaPlaybackService
{
private static final java.lang.String DESCRIPTOR = "com.okisum.andoyz.IMediaPlaybackService";
...
/**
 * Cast an IBinder object into an com.okisum.andoyz.IMediaPlaybackService interface,
 * generating a proxy if needed.
 */
public static com.okisum.andoyz.IMediaPlaybackService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.okisum.andoyz.IMediaPlaybackService))) {
return ((com.okisum.andoyz.IMediaPlaybackService)iin);
}
return new com.okisum.andoyz.IMediaPlaybackService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.okisum.andoyz.IMediaPlaybackService
{
